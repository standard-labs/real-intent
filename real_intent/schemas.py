...
class PII(BaseModel):
    ...
    pets_affinity: int = Field(..., alias="Pets_Affinity")
    health_affinity: int = Field(..., alias="Health_Affinity")
    diet_affinity: int = Field(..., alias="Diet_Affinity")
    fitness_affinity: int = Field(..., alias="Fitness_Affinity")
    outdoors_affinity: int = Field(..., alias="Outdoors_Affinity")
    boating_sailing_affinity: int = Field(..., alias="Boating_Sailing_Affinity")
    camping_hiking_climbing_affinity: int = Field(..., alias="Camping_Hiking_Climbing_Affinity")
    fishing_affinity: int = Field(..., alias="Fishing_Affinity")
    hunting_affinity: int = Field(..., alias="Hunting_Affinity")
    aerobics: int = Field(..., alias="Aerobics")
    nascar: int = Field(..., alias="NASCAR")
    scuba: int = Field(..., alias="Scuba")
    weight_lifting: int = Field(..., alias="Weight_Lifting")
    healthy_living_interest: int = Field(..., alias="Healthy_Living_Interest")
    motor_racing: int = Field(..., alias="Motor_Racing")
    foreign_travel: int = Field(..., alias="Travel_Foreign")
    self_improvement: int = Field(..., alias="Self_Improvement")
    walking: int = Field(..., alias="Walking")
    fitness: int = Field(..., alias="Fitness")
